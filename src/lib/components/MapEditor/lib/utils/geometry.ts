...
export function distance(point1: ElementPoint, point2: ElementPoint): number {
...
export function circle(center: ElementPoint, radius: number, steps: number): ElementPath {
